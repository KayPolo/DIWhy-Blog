...
function addLinks(parent){ //here I'm using an argument for my function
	...
	parent.innerHTML += "<a href = '#home'>TOP</a>"; 
	...
	parent.innerHTML += "<a href = '#exploration1'>EXPLORATION</a>";
	parent.innerHTML += "<a href = '#prototypes'>PROTOTYPES 1|2|3</a>";
	parent.innerHTML += "<a href = '#prototype4'>PROTOTYPE 4</a>";
	parent.innerHTML += "<a href = '#popup'>Pop-Up Show</a>";
